      ...
      <div>
        <Card className='w-[270px] p-4 min-h-[90vh] h-fit sticky top-10'>
          ...
          <div className='mt-8 flex flex-col gap-1'>
                ...
                <div className={cn('flex hover:bg-slate-50 duration-200 cursor-pointer items-center border hover:border-slate-300 border-slate-900/5 rounded-xl px-4 pl-3 py-2 gap-4',{"bg-primary hover:bg-primary/90 text-white":(pathname == "/dashboard" || pathname.includes("/dashboard/settings/"))})}>
